...
public class SchemeScanner2
{
   ...
   private static final int PARENTS = 4;
   ...
   private static final int matrix[][] =
   {
      ...
      /*  9 */ {
         ERR, 11, 10, 10, ERR, ERR, ERR
      },
      /* 10 */ {
         ERR, 11, ERR, ERR, ERR, ERR, ERR
      },
      /* 11 */ {
    ...
    */
   public SchemeScanner2(String sourcePath)
   {
      try
      {
...
//      SimpleDFAScanner scanner = new SimpleDFAScanner(args[0]);
      SchemeScanner2 scanner = new SchemeScanner2("inputMod.lisp");
      scanner.scan();
   }
}
