...
//            System.out.println(c);
            ...
            {//the first character
               ...
               {
                  continue;
               } //got to get to an actual character
               if (isSemiColon(c))
               {
         ...
         System.out.println("ctV: " + currentTokenValue);
      }
   ...
   {
      AltScanner scan = new AltScanner(new File("input.lisp"));
      System.out.println(scan.getNextToken());
   }
}
